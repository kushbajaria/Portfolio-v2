      ...
      <div className="max-w-5xl mx-auto px-4 py-8 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex flex-wrap items-center gap-3 justify-center md:justify-end w-full md:w-auto">
            <a
              ...
              className="inline-flex items-center gap-2 px-3 py-2 rounded-md bg-slate-50 border border-slate-300 text-slate-900 shadow-sm hover:bg-slate-100 dark:bg-white/5 dark:text-white dark:border-slate-700 dark:hover:bg-white/10 transition"
